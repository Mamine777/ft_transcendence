...
function setupNavigationListeners() {
    ...
    (_f = document.getElementById("backToDashboardFromProfile")) === null || _f === void 0 ? void 0 : _f.addEventListener("click", () => {
        window.location.hash = "#dashboardView";
        loadProfile();
    });
    (_g = document.getElementById("TournamentBtn")) === null || _g === void 0 ? void 0 : _g.addEventListener("click", () => {
        window.location.hash = "#TournamentView";
        loadProfile();
    });
    (_h = document.getElementById("backToFriendsFromList")) === null || _h === void 0 ? void 0 : _h.addEventListener('click', () => {
        switchView("dashboardView");
        loadProfile();
    });
    (_j = document.getElementById("backToFriendsFromRemove")) === null || _j === void 0 ? void 0 : _j.addEventListener('click', () => {
        switchView("dashboardView");
        loadProfile();
    });
    (_k = document.getElementById("backToFriendsFromAdd")) === null || _k === void 0 ? void 0 : _k.addEventListener('click', () => {
        switchView("dashboardView");
        loadProfile();
    });
    ...
    (_m = document.getElementById("backToDashboardFromGame")) === null || _m === void 0 ? void 0 : _m.addEventListener('click', () => {
        switchView("dashboardView");
        loadProfile();
    });
